...
- Name: buttons.spec.ts >> Botones de QuantitySelector >> botón increment existe y es clickeable
- Location: tests-functional/buttons.spec.ts:136:7
...
Locator: getByRole('button', { name: /increase/i }).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /increase/i }).first()
